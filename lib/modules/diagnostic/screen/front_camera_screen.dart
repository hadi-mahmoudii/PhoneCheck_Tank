...
class FrontCameraScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => FrontCameraScreenState();
}

class FrontCameraScreenState extends State<FrontCameraScreen> {
  ...
  @override
  void initState() {
    Get.find<TestController>().onStartTest(28, 15);
    initCamera();
    super.initState();
  }
