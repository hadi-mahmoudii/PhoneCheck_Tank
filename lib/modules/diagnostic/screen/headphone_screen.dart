...
class HeadphoneScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => HeadphoneScreenState();
}

class HeadphoneScreenState extends State<HeadphoneScreen> {
  ...
  void initState() {
    ...
    Get.find<TestController>().onStartTest(14, 15);
    initTest();
  }
      ...
      child: Scaffold(
        body: SafeArea(
          child: Column(
            ...
            children: [
              Expanded(
                child: headsetEvent == HeadsetState.CONNECT
                    ? Center(
                    ...
                    : Center(
                        child: Text("First, connect the headphones"),
                      ),
              ),
            ],
          ),
